package aigt.finaccounts.cor.handlers

import aigt.finaccounts.cor.CorDslMarker
import aigt.finaccounts.cor.ICorChainDsl
import aigt.finaccounts.cor.ICorExec
import aigt.finaccounts.cor.ICorExecDsl
 ...
 */
suspend fun <T> executeParallel(context: T, execs: List<ICorExec<T>>): Unit =
    coroutineScope {
        execs.forEach {
