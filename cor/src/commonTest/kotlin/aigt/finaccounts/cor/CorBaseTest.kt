...
import aigt.finaccounts.cor.handlers.CorChain
import aigt.finaccounts.cor.handlers.CorWorker
import aigt.finaccounts.cor.handlers.executeSequential
    ...
    fun `complex chain example`() = runTest {
        val chain = rootChain<TestContext> {
            worker {
                ...
                description =
                    "При старте обработки цепочки, статус еще не установлен. Проверяем его"
