...
class DefaultMarker(
    ...
    override fun add(reference: Marker): Unit {}
    ...
    override fun hasReferences(): Boolean =
        submarkers.isNotEmpty()

    override fun iterator(): Iterator<Marker> =
        submarkers.iterator()

    override fun contains(other: Marker): Boolean =
        submarkers.contains(other)

    override fun contains(name: String): Boolean =
        submarkers.any { it.name == name }

    override fun toString(): String =
        arrayOf(name, *submarkers.toTypedArray()).joinToString(",")
