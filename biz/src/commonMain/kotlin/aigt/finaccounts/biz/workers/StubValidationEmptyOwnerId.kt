...
fun ICorChainDsl<FinAccountsContext>.stubValidationEmptyOwnerId(title: String) =
    worker {
        this.title = title
        on { stubCase == ContextStubCase.EMPTY_OWNER_ID && state == ContextState.RUNNING }
        handle {
