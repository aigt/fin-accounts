...
fun ICorChainDsl<FinAccountsContext>.stubValidationBadTransactionType(title: String) =
    worker {
        this.title = title
        on { stubCase == ContextStubCase.BAD_TRANSACTION_TYPE && state == ContextState.RUNNING }
        handle {
            ...
            this.errors.add(
                ContextError(
                    ...
                    message = "Wrong transaction type field",
                ),
            )
        }
    }
