...
class AccountSearchResponseSerializationTest {

    private val response = AccountSearchResponse(
        responseType = "search",
    ...
    fun deserialize() {
        val json = apiV1ResponseSerialize(response)
        val obj = apiV1ResponseDeserialize<AccountSearchResponse>(json)
