...
class AccountReadResponseSerializationTest {

    private val response = AccountReadResponse(
        responseType = "read",
    ...
    fun deserialize() {
        val json = apiV1ResponseSerialize(response)
        val obj = apiV1ResponseDeserialize<AccountReadResponse>(json)
