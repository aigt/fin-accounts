...
class AccountUpdateResponseSerializationTest {

    private val response = AccountUpdateResponse(
        responseType = "update",
    ...
    fun deserialize() {
        val json = apiV1ResponseSerialize(response)
        val obj = apiV1ResponseDeserialize<AccountUpdateResponse>(json)
