...
class AccountHistoryResponseSerializationTest {

    private val response = AccountHistoryResponse(
    ...
    fun deserialize() {
        val json = apiV1ResponseSerialize(response)
        val obj = apiV1ResponseDeserialize<AccountHistoryResponse>(json)
