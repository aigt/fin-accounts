package aigt.finaccounts.blackbox.fixture.docker

import io.ktor.http.*

/**
 * Это обертка над сервисами в docker-compose. Позволяет их запускать и
 * останавливать, получать url для отправки запросов и очищать БД (чтобы между
 * тестами не делать пересоздание контейнеров)
 */
